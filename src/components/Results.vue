...
<template>
  <div class="flex flex-col h-full">
    <div class="flex items-center justify-center">
      <svg v-if="global.state.responseTotal === null" role="status" class="mt-20 mr-2 w-14 h-14 text-gray-200 animate-spin dark:text-gray-600 fill-iati-grey" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
