<template>
    ...
    >
        <defs>
            <polygon id="path-1" points="0 0 20 0 20 16.1904762 0 16.1904762" />
        </defs>
        <g
            id="Page-1"
            stroke="none"
        ...
        >
            <g id="News" transform="translate(-802.000000, -2677.000000)">
                <g id="Footer" transform="translate(0.000000, 2453.000000)">
                    <g
                        id="social-icon"
                        transform="translate(802.000000, 224.000000)"
                    >
                        <circle
                            id="Oval-2"
                            fill="#FFFFFF"
