...
<template>
  ...
  >
    <div class="max-w-sm p-6 bg-white divide-y divide-gray-500 rounded">
      ...
      <div class="mt-1">
        <p class="mb-4 mt-2 text-left text-md">
          Export currently selected filters to file?
        </p>
        <p class="mb-4 mt-2 text-left text-sm">
          This will allow you to import them later to run the same query or
