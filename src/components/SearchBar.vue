...
<div class="flex justify-left">
    <div class="flex border-2 rounded my-3">
        <input title="Search" aria-label="Search iati data" v-model="searchterm" type="text" class="px-4 py-2 placeholder-gray-600 w-auto" v-on:keyup.enter="global.runSimple(this.searchterm); this.$router.push('simple')" placeholder="Search IATI Activities...">
