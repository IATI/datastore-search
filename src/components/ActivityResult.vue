  ...
  <div class="flex flex-col h-full">
    <div class="flex-grow"><router-view />
        <div v-if="activity != null" class="grid grid-cols-10 gap-4 text-left mb-5">
          ...
          <div class="col-span-1"></div>
            <div class="col-span-2">Publisher: <b>{{ activity.reporting_org_narrative[0] }}</b></div>
            <div class="col-span-2">IATI Identifier <b>{{ activity.iati_identifier }}</b></div>
            <div class="col-span-2">Last updated: <b>{{ prettyDate(activity.last_updated_datetime) }}</b></div>
          ...
          <div class="col-span-1"></div>
          <div class="col-span-1"></div>
          <div class="col-span-9">Participating organisations: <span class="font-semibold" v-for="(org, index) in activity.participating_org_narrative" :key="index">{{org}}<span class="font-normal" v-if="index != activity.participating_org_narrative.length - 1"> | </span></span></div>
          <div class="col-span-1"></div>
