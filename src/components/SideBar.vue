    ...
    <div class="h-auto">
        ...
        <div id="buttons">
            ...
            >
                ...
                >
                    <PlayIcon
                        class="h-5 w-5 text-grey-300 mr-1 float-left"
                    /><span class="float-left">{{ $t('message.run') }}</span>
                </button>
                <button
                ...
                >
                    <ArrowDownIcon
                        class="h-5 w-5 text-grey-300 mr-1 float-left"
                    /><span class="float-left">{{ $t('message.export') }}</span>
                </button>
                <button
                ...
                >
                    <ArrowUpIcon
                        class="h-5 w-5 text-grey-300 mr-1 float-left"
                    /><span class="float-left">{{ $t('message.import') }}</span>
                </button>
                <button
                ...
                >
                    <PlusCircleIcon
                        class="h-5 w-5 text-grey-300 mr-1 float-left"
                    /><span class="float-left">{{ $t('message.add') }}</span>
                </button>
            </div>
